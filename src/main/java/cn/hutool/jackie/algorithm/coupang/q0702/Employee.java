...
abstract class Employee {
    ...
    public void receiveCall(Call call) {
        currentCall = call;
        System.out.println(this.getClass().getSimpleName() + "[" + employeeId + "] receive the call: " + call);
    }
    ...
    public void release() {
        if (callHandler != null && callHandler.callQueue != null && callHandler.callQueue.size() > 0) {
            callHandler.callQueue.remove(currentCall);
        }
        currentCall = null;
    }
