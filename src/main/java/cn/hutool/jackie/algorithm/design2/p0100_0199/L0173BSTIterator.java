...
public class L0173BSTIterator {
    ...
    public L0173BSTIterator(TreeNode root) {
        this.list = dfs(root);
    }

    public LinkedList<Integer> dfs(TreeNode node) {
    ...
    public static void main(String[] args) {
        TreeNode root = new TreeNode(7, new TreeNode(3, null, null),
                new TreeNode(15, new TreeNode(9, null, null), new TreeNode(20, null, null)));
        L0173BSTIterator iterator = new L0173BSTIterator(root);
        System.out.println(iterator.dfs(root));
